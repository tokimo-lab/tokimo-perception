...
impl OcrService {
    ...
    fn recognize_text(
        ...
        // Track timestep ranges for character-level positioning
        let mut char_timesteps: Vec<(usize, usize)> = Vec::new(); // (start_t, end_t) inclusive
        ...
        for t in 0..seq_len {
            ...
            if max_idx != 0 && max_idx != last_idx {
                // New character detected at timestep t
                ...
                // Transition from character to blank — next char starts after this
        ...
        // Convert timestep ranges to pixel positions within the bounding box.
        // Each timestep covers (bbox.w / seq_len) pixels in original image coords.
